...
#define MAX 11
/*
10. Demonstre  a  inserção  das  chaves  5,  28,  19,  15,  20,  33,  12,  7  e  10  numa  tabela  de  hash  com 
colisões  resolvidas  por  encadeamento  separado  (área  de  overflow)  .  Considere  a  tabela  com  m  =  9 
posições e a função hash como sendo  h(k) = k % m. Reconstrua a tabela para m = 11 (primo) e comente 
os resultados.
*/
