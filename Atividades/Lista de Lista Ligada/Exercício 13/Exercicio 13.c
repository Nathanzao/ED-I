...
/*
Escreva uma rotina que retorne um ponteiro para o último nó de uma l.
*/
...
struct no* retornaPonteiro(struct Lista *l){
...
struct Lista *lista = (struct Lista*) malloc(sizeof(struct Lista));
    ...
    struct no *ultmElem = retornaPonteiro(lista);

    printf("O conteudo do ultimo ponteiro, atraves do ponteiro retornado eh: %d.\n\n", ultmElem->elem);
