...
/*
Escreva uma rotina que retorne o produto dos números de uma lista.
*/
...
int produtoElementos(struct Lista *l){
    struct no *p = l->priElem;
    int produto = 1;
...
struct Lista *lista2 = (struct Lista*) malloc(sizeof(struct Lista));
    ...
    printf("O produto da primeira lista eh: %d.\n", produtoElementos(lista));
