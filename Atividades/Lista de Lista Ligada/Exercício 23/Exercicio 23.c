...
/*
Escreva uma rotina que retorne a diferença dos números de uma lista.
*/
...
int subtraiElementos(struct Lista *l){
    struct no *p = l->priElem;
    int subtrai = 0;
...
struct Lista *lista2 = (struct Lista*) malloc(sizeof(struct Lista));
    ...
    printf("A subtracao da primeira lista eh: %d.\n", subtraiElementos(lista));
