...
/*
3.  Escreva  uma  função  recursiva  que  verifica  se  um  valor  v  está  presente  na  árvore  t 
(considere que não há nenhuma garantia a respeito da ordem dos valores na árvore).  
