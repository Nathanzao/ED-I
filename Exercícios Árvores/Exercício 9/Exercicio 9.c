...
/*
9.  Escreva  uma  função  não-recursiva  que  recebe  uma  árvore  binária  de  busca  t  como 
parâmetro e retorna o apontador para o nó cuja chave possui o valor mínimo ou NULL 
